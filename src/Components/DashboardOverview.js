...
function DashboardOverview() {
  ...
  return (
    <div className='h-full border-b border-FTgreen pb-32 md:pb-16'>
          <div className='flex flex-wrap mt-6 justify-between md:justify-around lg:items-center h-[500px] lg:pl-16'>
            <div className='h-[300px] pl-6 w-[290px] md:w-[350px] flex flex-wrap md:h-full items-center'>
