...
function Hero() {
  return (
    <div className='w-full h-full flex flex-wrap justify-center md:flex-wrap-reverse mt-16 md:mt-36'>
            <div className='text-FTwhite pl-14 basis-full md:basis-1/2'>
                <h1 className='text-4xl mb-3'>Introducing a new way<br></br> to do finances</h1>
                <p className='mb-16 w-11/12 lg:w-3/4 mt-5 text-lg'>A modern way to keep track of your finaces and expenses all in one place.
